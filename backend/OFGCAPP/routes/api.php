...
Route::get('notis', 'App\Http\Controllers\Api\NotiController@index');
Route::get('notis/{noti}', 'App\Http\Controllers\Api\NotiController@show');
...
Route::middleware('auth:sanctum')->group( function () {
    ...
    Route::apiResource('notis', NotiController::class)->except(['index','show']);
});
